...
int snake_init(snake_game_t*, int, int);
...
void snake_get_head(snake_game_t* p_game, int *x, int *y);
void snake_set_head(snake_game_t* p_game, int x, int y);
int snake_get_snake_length(snake_game_t* p_game);
void snake_set_apple(snake_game_t* p_game, int x, int y);
void snake_get_apple(snake_game_t* p_game, int *x, int *y);
void snake_get_limits(snake_game_t* p_game, int *x, int *y);
