...
/*
        ...
        work_assign = esp_mqtt_client_subscribe(client, "LSE/machines/machine18/work_assignment", 0);
        ESP_LOGI(TAG, "sent subscribe successful, work_assign=%d", work_assign);
*/
...
void Publisher_Task(void *params)
{
    ...
    char *root_topic = "LSE/miriam.ortega@alumnos.upm.es/workers";
